...
| `profile [LIST/SHOW/DIFF/SWITCH/OFF/SAVE]` | profils de configuration nommes (`config/profiles/<nom>.conf`) surchargeant device.conf via `PROFILE=<nom>` ; SWITCH bascule, SAVE capture la base, DIFF montre les ecarts ; exemple fourni |

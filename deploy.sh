...
INSTALL_LIST="amorce boot reboot remote_map front_digit investigate stress_ram net_watch capture sync_usb disable_wireless inspect_usb inspect_proc inspect_dev media inspect_user inspect_system inspect_services inspect_display inspect_gui inspect_remote inspect_all device_info hdmi check_state conf_check help run_state recette selftest nreg config manage hw_report aliases profile ramstep xrun preflight show_key field_mode rotate_logs thermal vitals mem_tune cut_services system_rw front_led motd net_diag sys_diag sd_inspect sd_boot set_network set_time menu"

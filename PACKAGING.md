...
scripts/               depot thematise (boot/ optim/ inspect/ frontal/ outils/
                       + core/) ; le PAQUET reste A PLAT (staging pack.sh) :
                       contract box /data/scripts/*.sh sans dossier. Parent
                       rk322x.sh (racine depot) resout theme/outil/ID.
